...
public class kMotion : MonoBehaviour
{
    ...
    private void TrackPlayer()
    {
        ...
        if (CheckXMargin())
        {
            ...
            targetX = Mathf.Lerp(transform.position.x, m_Player.position.x, xSmooth * Time.deltaTime * cSpeed);
        }
        ...
        if (CheckYMargin())
        {
            ...
            targetY = Mathf.Lerp(transform.position.y, m_Player.position.y, ySmooth * Time.deltaTime * cSpeed);
        }
